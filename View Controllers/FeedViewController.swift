...
class FeedViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, MessageInputBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        tabelView.keyboardDismissMode = .interactive
        ...
        center.addObserver(self, selector: #selector(keyboardWilBeHidden(note:)), name: UIResponder.keyboardDidHideNotification, object: nil)
